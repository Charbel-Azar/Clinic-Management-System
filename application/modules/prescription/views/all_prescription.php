                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($prescriptions as $prescription) { ?>
                            <tr class="">
                                ...
                                <td>
                                    <a class="btn btn-info btn-xs " title="<?php echo lang('view'); ?>" href="prescription/viewPrescription?id=<?php echo $prescription->id; ?>" data-toggle="modal"><i class="fa fa-eye"> <?php echo lang('view'); ?></i></a>   
