...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <title> CMS |  <?php echo ucfirst($this->router->fetch_class()); ?> 
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <img alt="" src="uploads/icon.png" width="21" height="23">
                            ...
                            <ul class="dropdown-menu extended logout">
                                ...
                                <li style=" btn btn-login "><a href="auth/logout"><i class="fa fa-key"></i> <?php echo lang('log_out'); ?></a></li>
                            </ul>
                        </li>
