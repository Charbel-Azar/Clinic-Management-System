                            ...
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <section class="panel home_sec_blue">
                                        <div class="symbol "  style=" background: #0060f5;">
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <?php if ($this->ion_auth->in_group('admin')) { ?>
                                    ...
                                    <section class="panel home_sec_yellow">
                                        <div class="symbol" style="background: #9c09c4;">
                                    ...
                                    <div class="panel col-md-12">
                                        <div class="task-content panel">
                                            ...
                                            <div class="panel col-md-12 add-task-row">
                                                <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                                    <a class="btn editbutton btn-sm pull-left" href="notice/addNewView"><?php echo lang('add'); ?> <?php echo lang('notice'); ?></a>
                                                <?php } ?>
