    ...
    function send() {
        ...
        if (!empty($to)) {
            ...
            if ($this->email->send()) {
                ...
                $error_message = $this->email->print_debugger(); // Get the error message or debug information

                // Log or display the error message for troubleshooting
                log_message('error', 'Email sending failed: ' . $error_message);
