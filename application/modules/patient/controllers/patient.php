...
// Validating Deposited Amount Field
                                                ...
                                                <div class="activity-desk">
                                                    <div class="panel col-md-6">
                                                        <div class="panel-body">
                                                            ...
                                                            <i class=" fa fa-user-md"></i>
                                                                <h4>' . $doctor_name . '</h4>
                                                                    <a class="btn btn-info btn-xs editbutton2" href="prescription/viewPrescription?id=' . $prescription->id . '"><i class="fa fa-eye"> View</i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    function getPatient() {
        ...
        foreach ($data['patients'] as $patient) {
            ...
            //$options4 = '<a title="' . lang('payment') . '"" href="finance/patientPaymentHistory?patient=' . $patient->id . '">';
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist', 'Laboratorist', 'Nurse', 'Doctor'))) {
    ...
    function getDocuments() {
        ...
        foreach ($data['documents'] as $document) {
            ...
            $info[] = array(
                ...
                $patient_details,
                $document->title,
                '<iframe src="' . $document->url . '" width="100px" height="100px"></iframe>',
                $options1 . ' ' . $options2
                    // $options4
            );
        }
