                ...
                <div class="col-md-4 no-print pull-right"> 
                    <a data-toggle="modal" href="#myModal">
                        <div class="btn-group pull-right">
                            <button id="" class="btn editbutton2 btn-xs">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"> <?php echo lang('insurance') ?></label>
                        <input type="text" class="form-control" name="insurance" id="exampleInputEmail1" value='' placeholder="">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row">
                <form role="form" id="editPatientForm" action="patient/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group last col-md-12 tecenter">
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    <img src="uploads/icon.png" id="img1" alt="" />
                                </div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                            </div>
                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".editbutton", function () {
        ...
        $.ajax({
            ...
            $('#editPatientForm').find('[name="insurance"]').val(response.patient.insurance).end()
...
<script type="text/javascript">
    ...
    $(".table").on("click", ".inffo", function () {
        ...
        $.ajax({
            ...
            $('.insuranceClass').append(response.patient.insurance).end()
