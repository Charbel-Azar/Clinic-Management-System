                                        ...
                                        <?php foreach ($appointment_pendings as $appointment) { ?>
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-info btn-xs btn_width editbutton" data-toggle="modal" style=" font-family: 'Open Sans', sans-serif !important;"data-id="<?php echo $appointment->id; ?>"><i class="fa fa-edit"> <?php echo lang('edit'); ?></i></button>   
