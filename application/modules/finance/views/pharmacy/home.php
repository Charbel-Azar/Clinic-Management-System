            ...
            <div class="row state-overview">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="custom-bar-chart" style="padding: 0px 10px;">
                        <ul class="y-axis">
                        <li><span><?php echo $settings->currency; ?>1000</span></li>
                    <li><span><?php echo $settings->currency; ?>800</span></li>
                    <li><span><?php echo $settings->currency; ?>600</span></li>
                    <li><span><?php echo $settings->currency; ?>400</span></li>
                    <li><span><?php echo $settings->currency; ?>200</span></li>
                    <li><span><?php echo $settings->currency; ?>0</span></li>
                        ...
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($feb)) {
                                     echo 'height:' . array_sum($feb) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($mar)) {
                                     echo 'height:' . array_sum($mar) * 100 / 1000;
                                 }
                                 ?>%"></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($apr)) {
                                     echo 'height:' . array_sum($apr) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($may)) {
                                     echo 'height:' . array_sum($may) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($jun)) {
                                     echo 'height:' . array_sum($jun) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($jul)) {
                                     echo 'height:' . array_sum($jul) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($aug)) {
                                     echo 'height:' . array_sum($aug) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($sep)) {
                                     echo 'height:' . array_sum($sep) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($oct)) {
                                     echo 'height:' . array_sum($oct) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($nov)) {
                                     echo 'height:' . array_sum($nov) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                        <div class="bar ">
                            ...
                            ?>" data-toggle="tooltip" data-placement="top" style="<?php
                                 if (!empty($dec)) {
                                     echo 'height:' . array_sum($dec) * 100 / 1000;
                                 }
                                 ?>%""></div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover personal-task">
                            <tbody>  
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-warning" style="background-color:maroon !important;">
                                            <?php
                                            $query_medicine = $this->db->get('medicine')->result();
                                            $i = 0;
                                            foreach ($query_medicine as $q_medicine) {
